...
import { useContextShowPageTitle, useContextUserData, useReturnComponent } from '../hooks'
    ...
    return <main>
        <div className='container '>
            <div className='w-full sticky -top-0 z-50'>
                <Nav className='w-full flex justify-center items-center gap-40 border-b py-2 px-1 bg-white' Children={
                    <>
